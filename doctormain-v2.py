...
class Doctor:        
    def __init__(self,doctor):
        ...
        self.tree.column("#0", stretch=YES, minwidth=0, width=-20)
        ...
        self.Text_box1 = Entry(self.doctor, font=("default", 15))
        
        self.Text_box1.place(relx=0.66, rely=0.28,height = 140, width = 392)
        self.Text_box1.insert(0, 'Add diagnosis...')

        self.Text_box2 = Entry(self.doctor, font=("default", 15))
        self.Text_box2.place(relx=0.66, rely=0.51,height = 140, width = 392)
        self.Text_box2.insert(0, 'Enter prescription...')
    ...
    def add_details(self):
        global x,y
        x = self.Text_box1.get()
        y = self.Text_box2.get()
        print(self.sel)
        if len(self.sel)==0:
            messagebox.showwarning('#ErrorSB404', 'No record selected')
        else:
            p = vall.pop(5)
            q = vall.pop(5)
            ...
            messagebox.showinfo("Success!!", "Account successfully updated in database.", parent=self.doctor)
...
class Update_Employee:
    def __init__(self, top=None):
        ...
        self.entry1.configure(font=("gotham", 13, "bold"),bg='white',fg='black')
        self.entry1.configure(relief="flat")
        
        self.entry1 = Text(e_update)
        self.entry1.insert(INSERT,vall[6])
        self.entry1.place(relx=0.547, rely=0.550,width=455,height=136)
        self.entry1.configure(font=("gotham", 13, "bold"),bg='white',fg='black')
        self.entry1.configure(relief="flat") 
